...
const ExpansionBody = ({ expansion }) => {
    ...
    return (
        <>
            <main class="expansion-body row bg-secondary col-lg-8 col-sm-12 mx-0 p-4 px-4 border border-dark bs-lift">
                <section class="row bg-light pt-1 mx-0 border border-dark bs-lift justify-content-center">
                    <ExpImages cardSet={expansion} />
                    <div class="col-xl-6 col-lg-5 col-sm-8 text-start my-5 px-3 d-block justify-content-center">
