      ...
      <div class="landing-body">
        ...
        <section class="landing-set-container">
          ...
          <div class="landing-sets row">
            ...
            <div class="col">
              <img src="https://i.imgur.com/WUVqIZa.jpg" alt="" />
              <h3>Jungle</h3>
            </div>
            <div class="col">
              <img src="https://i.imgur.com/fzPnBJi.jpg" alt="" />
              <h3>Fossil</h3>
            </div>
            <div class="col">
              <img src="https://i.imgur.com/l4fcVLN.jpg" alt="" />
              <h3>Base Set 2</h3>
            </div>
            <div class="col">
              <img src="https://i.imgur.com/Hj0RN6t.jpg" alt="" />
              <h3>Team Rocket</h3>
            </div>
            <div class="col">
              <img src="https://i.imgur.com/dk730u5.jpg" alt="" />
              <h3>Gym Heroes</h3>
            </div>
            <div class="col">
              <img src="https://i.imgur.com/tsM9xhr.jpg" alt="" />
              <h3>Gym Challenge</h3>
            </div>
          </div>
        </section>
